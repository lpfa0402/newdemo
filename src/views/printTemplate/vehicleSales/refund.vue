<template>
  <div v-show="isPreview" ref="print" style="width: 800px; margin: 0 auto;">
    <table cellspacing="0" width="100%" style="border-collapse: collapse; border-spacing: 0;">
      <tr>
        <td colspan="7" align="center" height="24" style="font-size: 24px;">退款单</td>
      </tr>
      <tr>
    ...
    <table cellspacing="0" width="100%" style="border-collapse: collapse; border-spacing: 0;">
      ...
      <tr>
        ...
        <td width="30%" style="border: 1px solid #000; font-size: 14px;">客户退回定金</td>
      ...
      <tr>
        <td colspan="4" style="border: 1px solid #000; font-size: 14px;">退款单位盖章</td>
      </tr>
    </table>
...
export default {
  ...
  mounted() {
    ...
    this.data.buildDate = moment(this.data.buildDate).format('YYYY-MM-DD');
