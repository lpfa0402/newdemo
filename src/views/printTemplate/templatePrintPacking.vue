  ...
  <div ref="print" style="width:100%; margin: 0 auto;">
    ...
    >
      <table border="1">
        <tr height="70px">
          <td colspan="6">
            <p style="text-align:center;font-size:25px;font-weight:700">装箱单</p>
            <span>
              服务站代码：
              <p style="position:absolute;left:540px;top:180px">打印日期：{{ nowTime }}</p>
            </span>
          </td>
        </tr>
        <tr height="35px">
          ...
          <td>
            <p align="center">申请单号</p>
          </td>
          <td>
            <p align="center">索赔件代码</p>
          </td>
          <td>
            <p align="center">索赔件名称</p>
          </td>
          <td>
            <p align="center">数量</p>
          </td>
          <td>
            <p align="center">厂家代码</p>
          </td>
        </tr>
        <tr v-for="(x,index) in this.data" :key="x.$index" height="35px">
          ...
          <td>
            <p align="center">{{x.vfactorycode}}</p>
          </td>
        </tr>
      </table>
    </div>
...
export default {
  ...
  created() {
    console.log(this.data[0].$index, '打印数据');
  },
  mounted() {
