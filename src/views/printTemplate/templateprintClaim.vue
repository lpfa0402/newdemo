  ...
  methods: {
    ...
    createTableInfo() {
      ...
      for (var i = 0; i < dataLength; i++) {
        ...
        dataStr += '<tbody>';
        dataStr += "<tr style='height:15px;font-weight:bold'>";
        dataStr += "<td style='text-align:left;font-size:12px;' colspan='4'>中国第一汽车股份有限公司</td>";
        dataStr += '</tr>';
        dataStr += "<tr style='height:10px;text-decoration: underline;'>";
